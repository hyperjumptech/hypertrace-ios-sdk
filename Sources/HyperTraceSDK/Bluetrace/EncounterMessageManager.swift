...
class EncounterMessageManager {
  ...
  func setAdvtPayloadIntoUserDefaultsv2(_ response: (tempIds: [TempId], refreshDate: Date)) -> Data? {
    ...
    do {
      ...
      UserDefaults.standard.set(encodedPeriCharStruct, forKey: userDefaultsAdvtKey)
      UserDefaults.standard.set(response.refreshDate, forKey: userDefaultsAdvtExpiryKey)
